    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('STUDENT', 'Student'), ('DEPARTMENT', 'Department'), ('ADMIN', 'Admin')], default='STUDENT', max_length=20)),
                ('department', models.CharField(choices=[('CSE', 'Computer Science & Engineering'), ('ECE', 'Electronics & Communication Engineering'), ('EEE', 'Electrical & Electronics Engineering'), ('MECH', 'Mechanical Engineering'), ('CIVIL', 'Civil Engineering'), ('ALL', 'All Departments')], default='CSE', max_length=10)),
